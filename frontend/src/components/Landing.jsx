        ...
        <div className="beauty-journey-container mt-20">
            ...
            <div className="small-business-container">
                ...
                <p className="small-business-text">
                    ...
                    small businesses can effortlessly manage appointments, allocate resources efficiently, and reduce no-shows through automated reminders. Moreover, our platform offers cost-effective subscription plans tailored to the needs and budgets of small businesses, eliminating the burden of hefty upfront investments. We also prioritize customer support, ensuring that even the smallest businesses receive personalized assistance and guidance every step of the way. By empowering small beauty shops with the tools and support they need to thrive in the digital age, our platform fosters growth, enhances customer satisfaction, and cultivates long term success. and increase customer satisfaction.
                </p>
            </div>
